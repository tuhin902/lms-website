  ...
  return (
    <div className={styles.container}>
      <div className={styles.address}>
        <p className={styles.addresstext}>Education</p>
        <p>
          <svg
      ...
      <form action="">
        <div className={styles.inputcontainer}>
          <div>
            <p className={styles.presenttext}>Present Address</p>
            ...
            <div className={styles.presentbottom}>
              <div>
                <label htmlFor="areatype">Area Type</label>
                <input type="text" name="areatype" id="areatype" />
              </div>
              <div>
          ...
          <div>
            <p className={styles.parmanenttext}>Parmanent Address</p>
            <div className={styles.parmanenttop}>
              <div>
                <label htmlFor="yourcountry"> Your Country</label>
                <input type="text" name="yourcountry" id="yourcountry" />
              </div>
            ...
            <div className={styles.parmanentbottom}>
              <div>
                <label htmlFor="areatype">Area Type</label>
                <input type="text" name="areatype" id="areatype" />
              </div>
